 ...
 */
public class MyRequestsFragment extends BaseFragment implements WCFServiceCallback<ArrayList<CarShareRequest>, String> {
    ...
    public void onServiceCallCompleted(final ServiceResponse<ArrayList<CarShareRequest>> serviceResponse, String parameter) {
        ...
        final ListView mainListView = (ListView) getView().findViewById(R.id.MyRequestsListView);
        TextView noRequestsTextView = (TextView) getActivity().findViewById(R.id.MyRequestsNoRequestsTextView);
        ...
        if(serviceResponse.ServiceResponseCode == ServiceResponseCode.SUCCESS)
        {
            ...
            new WCFServiceTask<ArrayList<Integer>, ArrayList<CarShare>>("https://findndrive.no-ip.co.uk/Services/CarShareService.svc/getmultiple", ids,
                ...
                public void onServiceCallCompleted(ServiceResponse<ArrayList<CarShare>> filteredCarShares, String parameter) {
                    ...
                    MyRequestsAdapter adapter = new MyRequestsAdapter(getActivity(), R.layout.fragment_my_requests_listview_row, serviceResponse.Result);
