...
public class AddToBuddiesTask extends AsyncTask<TextView, String, Boolean> {
    ...
    private TravelBuddyDTO travelBuddyDTO;
    private ServiceResponse serviceResponse;
    private final String TAG = this.getClass().getSimpleName();

    public AddToBuddiesTask(TravelBuddyDTO travelBuddyDTO)
    {
        this.travelBuddyDTO = travelBuddyDTO;
    }
    ...
    protected Boolean doInBackground(TextView... textViews) {
        try {
            ...
            Gson gson = new Gson();
            String jsonLoginDTO = gson.toJson(travelBuddyDTO);
