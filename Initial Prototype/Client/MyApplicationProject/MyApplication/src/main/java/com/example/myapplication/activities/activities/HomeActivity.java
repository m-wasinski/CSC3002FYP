    ...
    public void onClick(View view) {
        switch(view.getId())
        {
            ...
            case R.id.ActivityHomeNotificationsLayout:
                startActivity(new Intent(getApplicationContext(), MyNotificationsActivity.class));
                break;
            ...
            case R.id.ActivityHomeMyOfferJourneyLayout:
                ...
                startActivity( new Intent(getApplicationContext(), OfferJourneyStepOneActivity.class).putExtras(bundle));
                break;
