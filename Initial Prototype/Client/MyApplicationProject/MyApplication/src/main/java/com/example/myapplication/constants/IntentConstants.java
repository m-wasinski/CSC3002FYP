...
/**
 * Contains the list of all tag used when transferring data inside bundles and intents.
 */
public class IntentConstants
{
    public static final String GCM_NOTIFICATION_TYPE = "notificationType";
    public static final String JOURNEY = "journey";
    public static final String JOURNEY_TEMPLATE = "journey_search_dto";
    ...
    public static final String NEW_JOURNEY_MESSAGES = "new_journey_messages";
