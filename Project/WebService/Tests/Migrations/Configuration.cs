namespace Tests.Migrations
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataAccessLayer.Migrations.Configuration"/> class.
        /// </summary>
        ...
        /// The arr.
        /// </param>
        private void AddAdministrator(TestContext context, byte[] arr)
        {
        ...
        /// The arr.
        /// </param>
        private void AddJourneysAndPassengers(TestContext context, byte[] arr)
        {
        ...
        /// The context.
        /// </param>
        private void AddNotifications(TestContext context)
        {
            for (var i = 0; i < 100; i++)
            {
